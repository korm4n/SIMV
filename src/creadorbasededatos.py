        ...
        try:
            ...
            cursor.execute('''
                CREATE TABLE IF NOT EXISTS HistoriaClinicaAntecedentesFamiliares2 (
                    ...
                    otros_10_4 TEXT,
                    disfagia TEXT,
                    dolor_de_garganta TEXT,
                    ronquera TEXT,
                    otros_11_4 TEXT,
                    disnea_respiratoria TEXT,
                    dolor_en_el_pecho TEXT,
                    esputos TEXT,
                    hemoptisis TEXT,
                    tos TEXT,
                    otros_12_6 TEXT,
                    ...
                    otros_13_5 TEXT,
                    angustias TEXT,
                    disnea_cardiovascular TEXT,
                    dolor_cardiovascular TEXT,
                    palpitaciones TEXT,
                    taquicardia TEXT,
                    vertigos TEXT,
                    claudicacion TEXT,
                    trastornos_parestesicos TEXT,
                    varicosidades TEXT,
                    otros_14_10 TEXT,
                    apetito TEXT,
                    constipacion TEXT,
                    diarrea TEXT,
                    dolor_gastroinstestinal TEXT,
                    heces_tipo_color_mucosidad_sangre TEXT,
                    eruptos TEXT,
                    flatulencias TEXT,
                    hemorroides TEXT,
                    hernias TEXT,
            ...
            cursor.execute('''
                CREATE TABLE IF NOT EXISTS HistoriaClinicaAntecedentesFamiliares3 (
                    ...
                    frigidez TEXT,
                    menopausia TEXT,
                    regla_tipo_cantidad_dolor_ultimaregla TEXT,
                    flujo TEXT,
                    otros_17_9 TEXT,
                    convulsiones TEXT,
                    estatica TEXT,
