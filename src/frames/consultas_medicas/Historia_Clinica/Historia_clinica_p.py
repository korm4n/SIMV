import sys
from PySide6.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QScrollArea, QToolButton, QFrame
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        def crear_seccion(titulo, campos):
        ...
        antecedentes_personales_campos = [
            "adenitis", "alergia", "amigdalitis", "artritis", "asma", "Bilharziasis", "blenorragia",
        ...
        antecedentes_personales_layout = crear_seccion("Antecedentes Personales", antecedentes_personales_campos)
        main_layout.addLayout(antecedentes_personales_layout)

        antecedentes_familiares_campos = [
            "alergia", "artritis", "cancer", "cardio_vasculares", "diabetes", "enf_digestivas",
            "enf_renales", "intoxicaciones", "neuromentales", "sifilis", "tuberculosis", "otros_2_12"
        ]
        antecedentes_familiares_layout = crear_seccion("Antecedentes Familiares", antecedentes_familiares_campos)
        ...
        habitos_psicologicos_campos = [
            ...
            "rasgos_personales", "sexuales", "siesta", "sueño", "tabaco", "otros_3_12"
        ]
        habitos_psicologicos_layout = crear_seccion("Hábitos Psicológicos", habitos_psicologicos_campos)
        ...
        examen_funcional_general_layout = crear_seccion("Examen Funcional General", examen_funcional_general_campos)
        ...
        piel_layout = crear_seccion("Piel", piel_campos)
        ...
        cabeza_layout = crear_seccion("Cabeza", cabeza_campos)
        ...
        ojos_layout = crear_seccion("Ojos", ojos_campos)
        ...
        oidos_layout = crear_seccion("Oídos", oidos_campos)
        ...
        nariz_layout = crear_seccion("Nariz", nariz_campos)
        ...
        pulmones_layout = crear_seccion("Pulmones", pulmones_campos)
        main_layout.addLayout(pulmones_layout)

        corazon_campos = [
            "latidos_de_la_punta", "thrill", "pulsacion", "ritmo", "ruidos", "galopes", "frotes", "otros_13_8"
        ]
        corazon_layout = crear_seccion("Corazón", corazon_campos)
        main_layout.addLayout(corazon_layout)

        vasos_campos = [
            "pulso", "paredes_vasculares", "caracteres", "otros_14_4"
        ]
        vasos_layout = crear_seccion("Vasos Sanguíneos", vasos_campos)
        ...
        abdomen_layout = crear_seccion("Abdomen", abdomen_campos)
        ...
        genitales_masculinos_layout = crear_seccion("Genitales Masculinos", genitales_masculinos_campos)
        ...
        genitales_femeninos_layout = crear_seccion("Genitales Femeninos", genitales_femeninos_campos)
        ...
        recto_layout = crear_seccion("Recto", recto_campos)
        ...
        huesos_layout = crear_seccion("Huesos, Articulaciones y Músculos", huesos_campos)
        main_layout.addLayout(huesos_layout)

        extremidades_campos = [
            "color_piel", "edema", "temblor", "deformidades_piel", "ulceras_piel", "varices", "otros_20_7"
        ]
        extremidades_layout = crear_seccion("Extremidades", extremidades_campos)
        ...
        neurologico_layout = crear_seccion("Neurológico y Psíquico", neurologico_campos)
